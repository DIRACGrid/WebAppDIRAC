...
sencha -sdk $BASE_PATH/static/extjs/ext-4.1.1a/src compile -classpath=$BASE_PATH/static/extjs/ext-4.1.1a/examples/ux/form,$BASE_PATH/static/core/js/utils,$BASE_PATH/static/core/js/core -debug=true page -yui  -in $BASE_PATH/template/build/root.tpl -out $BASE_PATH/static/core/build/index.html

#removing the generated files
rm -r $BASE_PATH/static/core/build/index.html

#optimizing JavaScript for the JobMonitor app
sencha -sdk $BASE_PATH/static/extjs/ext-4.1.1a/src compile -classpath=$BASE_PATH/static/extjs/ext-4.1.1a/examples/ux/form,$BASE_PATH/static/core/js/utils,$BASE_PATH/static/core/js/core,$BASE_PATH/static/DIRAC/JobMonitor/classes -debug=true page -yui  -in $BASE_PATH/template/JobMonitor/standalone.tpl -out $BASE_PATH/static/DIRAC/JobMonitor/build/index.html
