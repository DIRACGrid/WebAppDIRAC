Ext.define("DIRAC.RegistryManager.classes.RegistryManager", {
            ...
            if (
              ...
              switch (me.gridContextMenu.selectedType) {
                case "voms":
                  ...
                  break;
                case "servers":
                  var record = GLOBAL.APP.CF.getSelectedRecords(
                    me.serversGrid
                  )[0];
                  me.__createServerForm(record);
                  break;
          ...
          handler: function() {
            if (
              ...
              if (me.gridContextMenu.selectedType == "voms") {
                sName = GLOBAL.APP.CF.getFieldValueFromSelectedRow(
                  me.vomsGrid,
                  "name"
                );
  ...
  afterRender: function() {
    ...
    me.grid.body.on("contextmenu", function(e, t, eOpts) {
      ...
      var sNewNoun = me
        .getSelectedType()
        .substr(0, me.getSelectedType().length - 1);
  ...
  __createGroupForm: function(oRecord) {
    ...
    if ("groupForm" in me) {
      ...
      me.groupForm.cbAutoUploadPilotProxy = Ext.create(
        "Ext.form.field.ComboBox",
        {
      ...
      me.groupForm.msProperties = me.__createMultiListWithButtons(
        "Properties",
        [],
        null
      );
      me.groupForm.msUsers = me.__createMultiListWithButtons(
        "Users",
        [],
        function(sNewUser) {
    ...
    if (oRecord != null && oRecord != undefined) {
      ...
      me.groupForm.cbAutoUploadPilotProxy.setValue(
        oRecord.get("autouploadpilotproxy")
      );
  ...
  __createHostForm: function(oRecord) {
    ...
    if ("hostForm" in me) {
      ...
      me.hostForm.msProperties = me.__createMultiListWithButtons(
        "Properties",
        [],
        null
      );
  ...
  __createServerForm: function(oRecord) {
    ...
    me.rightPanel.removeAll();
    me.rightPanel.add([
      me.serverForm.txtName,
      me.serverForm.txtDn,
      me.serverForm.txtPort,
      me.serverForm.txtCa
    ]);
  },
  ...
  __createMultiListWithButtons: function(
    sTitle,
    oData,
    funcOnAddValidationFunction
  ) {
    var me = this;
  ...
  __showFormForRegistryOption: function() {
    ...
    me.btnCreateElement = new Ext.Button({
      ...
      handler: function() {
        ...
        if (bValid) {
          me.rightPanel.add(
            me.__createRegistryProperty(
              me.txtElementName.getValue(),
              me.txtElementValue.getValue()
            )
          );
  ...
  __createVomsMappingForm: function(oData) {
    ...
    for (var i = 0; i < oData.length; i++) {
      me.rightPanel.add(
        me.__createRegistryProperty(oData[i]["name"], oData[i]["value"])
      );
    }
  }
});
