      ...
      Visible: [
        {
          ...
          properties: {
            tooltip:
              "Click to show the jobs which belong to the selected request."
          }
        },
        {
          text: "-" // separator
  ...
  __getSelectedValues: function() {
    ...
    if (me.grid.expandedGridPanel) {
      if (!me.grid.expandedGridPanel.isExpanded) {
        values.name = GLOBAL.APP.CF.getFieldValueFromSelectedRow(
          me.grid,
          "Name"
        );
        values.elementType = GLOBAL.APP.CF.getFieldValueFromSelectedRow(
          me.grid,
          "ElementType"
        );
        values.statusType = GLOBAL.APP.CF.getFieldValueFromSelectedRow(
          me.grid,
          "StatusType"
        );
        values.lastCheckTime = Ext.Date.format(
          GLOBAL.APP.CF.getFieldValueFromSelectedRow(me.grid, "LastCheckTime"),
          "Y-m-d H:i:s"
        );
      } else {
        ...
        values.lastCheckTime = Ext.Date.format(
          GLOBAL.APP.CF.getFieldValueFromSelectedRow(
            me.grid.expandedGridPanel,
            "LastCheckTime"
          ),
          "Y-m-d H:i:s"
