...
Ext.define("DIRAC.TransformationMonitor.classes.TransformationMonitor", {
  ...
  buildUI: function() {
    ...
    var showJobshandler = function() {
      var oId = GLOBAL.APP.CF.getFieldValueFromSelectedRow(
        me.grid,
        "TransformationID"
      );
      ...
      Visible: [
        {
          ...
          properties: {
            tooltip:
              "Click to show the jobs which belong to the selected transformation(s)."
          }
        },
        {
          text: "-"
        },
        {
          ...
          properties: {
            tooltip:
              "Click to show the logging information of the selected transformation."
          }
        },
        {
          text: "Workflow xml",
          ...
          properties: {
            tooltip:
              "Click to show the workflow information of the selected transformation."
          }
        },
        {
          text: "File Status",
          ...
          properties: {
            tooltip:
              "Click to show the file status of the selected transformation."
          }
        },
        {
          text: "-"
        ...
        },
        {
          ...
          properties: {
            tooltip:
              "Click to show a detailed description of the selected transformation."
          }
        },
        {
          text: "-"
      ...
      success: function(response) {
        ...
        if (jsonData["success"] == "true") {
          if (oDataKind == "getLoggingInfo") {
            ...
            var xmlText =
              '<?xml version="1.0" encoding="UTF-8" ?>' + jsonData["result"];
              ...
              var win = GLOBAL.APP.MAIN_VIEW.getRightContainer().createModalWindow(
                {
                  ...
                  listeners: {
                    render: function() {
                      ...
                      xmlContainer.update(
                        "<pre>" + Ext.util.Format.htmlEncode(xmlText) + "</pre>"
                      );
                    }
                  }
                }
  ...
  __showFileStatus: function(parent, status) {
    var me = this;
    oId = GLOBAL.APP.CF.getFieldValueFromSelectedRow(
      parent.grid,
      "TransformationID"
    );
    ...
    parent
      .getContainer()
      .showInWindow(
        "Files with status " + oStatus + " for production:" + oId,
        oGrid
      );
  ...
  __flushRun: function(parentGrid) {
    var me = this;
    var oRunNumberId = GLOBAL.APP.CF.getFieldValueFromSelectedRow(
      me,
      "RunNumber"
    );
    var oTransFormationId = GLOBAL.APP.CF.getFieldValueFromSelectedRow(
      parentGrid,
      "TransformationID"
    );
  ...
  __setSite: function(parentGrid, site) {
    ...
    var msg =
      "Are you sure you want to set site " +
      site +
      " for the run " +
      oRunNumberId +
      " in production " +
  ...
  __extendTransformation: function() {
    var me = this;
    var id = GLOBAL.APP.CF.getFieldValueFromSelectedRow(
      me.grid,
      "TransformationID"
    );
    Ext.Msg.prompt(
  ...
  __oprTransformationAction: function(oAction, useGridTransformationId) {
    ...
    if (oItems.length == 1)
      ...
      c = confirm(
        "Are you sure you want to " + oAction + " these transformations?"
      );
