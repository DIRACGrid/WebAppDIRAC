Ext.define("DIRAC.JobMonitor.classes.JobMonitor", {
  ...
  getStateData: function() {
    ...
    oReturn.statisticsSelectionPanelCollapsed =
      me.statisticsSelectionGrid.collapsed;
    oReturn.statisticsSelectionValues = [
      me.statisticsGridComboMain.getValue(),
      me.statisticsGridCombo.getValue()
    ];
  ...
  initComponent: function() {
    ...
    if (GLOBAL.VIEW_ID == "tabs") {
      ...
      me.launcher.width = oDimensions[0];
      me.launcher.height =
        oDimensions[1] - GLOBAL.APP.MAIN_VIEW.taskbar
  ...
  buildUI: function() {
    ...
    me.statisticsPlotPanel.onResize = function(
      width,
      height,
      oldWidth,
      oldHeight
    ) {
      me.createPlotFromGridData(
        me.statisticsGridComboMain.getValue() +
          " :: " +
          me.statisticsGridCombo.getValue()
      );
    ...
    me.statisticsPanel.add([
      me.statisticsSelectionGrid,
      me.statisticsPlotPanel
    ]);
  ...
  formPlotSettings: function() {
    ...
    me.plotSettings.cmbLegendPosition = new Ext.create(
      "Ext.form.field.ComboBox",
      {
        labelAlign: "left",
    ...
    me.plotSettings.btnApplySettings = new Ext.Button({
      ...
      handler: function() {
        var me = this;
        me.createPlotFromGridData(
          me.plotSettings.txtPlotTitle.getValue(),
          me.plotSettings.cmbLegendPosition.getValue()
        );
      },
      scope: me
    });
    ...
    var oPanel = new Ext.create("Ext.panel.Panel", {
      ...
      items: [
        oToolbar,
        me.plotSettings.txtPlotTitle,
        me.plotSettings.cmbLegendPosition,
        me.txtElementConfig
      ]
    });
  ...
  createPlotFromGridData: function(sTitle, sLegendPosition) {
    ...
    me.statisticsSelectionGrid.plot = Ext.create("Ext.chart.PolarChart", {
      ...
      background: {
        ...
        src:
          GLOBAL.ROOT_URL +
          "static/core/img/wallpapers/dirac_jobmonitor_background.png"
      },
    ...
    me.statisticsSelectionGrid.on("sortchange", function(
      ct,
      column,
      direction,
      eOpts
  ...
  __oprJobAction: function(oAction, useSelectedJobId) {
    ...
    if (oItems.length == 1)
      c = confirm(
        "Are you sure you want to " + oAction + " " + oItems[0] + "?"
      );
    ...
    Ext.Ajax.request({
      ...
      success: function(response) {
        ...
        if (jsonData["success"] == "true") {
          if (oDataKind == "getJDL") {
            // text
            me.getContainer().oprPrepareAndShowWindowText(
              jsonData["result"],
              "JDL for JobID:" + oId
            );
            ...
            me.getContainer().oprPrepareAndShowWindowText(
              jsonData["result"],
              "Standard output for JobID:" + oId
            );
          } else if (oDataKind == "getLogURL") {
            me.getContainer().oprShowInNewTab(
              jsonData["result"],
            ...
            me.getContainer().oprPrepareAndShowWindowText(
              jsonData["result"],
              "Stager report for JobId:" + oId
            );
          } else if (oDataKind == "getPilotStdOut") {
            me.getContainer().oprPrepareAndShowWindowText(
              jsonData["result"],
              "Pilot StdOut for JobID:" + oId
            );
          } else if (oDataKind == "getPilotStdErr") {
            me.getContainer().oprPrepareAndShowWindowText(
              jsonData["result"],
              "Pilot StdErr for JobID:" + oId
            );
          }
        } else {
