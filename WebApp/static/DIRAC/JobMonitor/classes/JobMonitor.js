     ...
     me.dataStore = Ext.create("Ext.dirac.utils.DiracJsonStore",{
	  ...
	  var pagingToolbar = {};
       ...
       scope : me
		...
		var oColumns = {
		    "checkBox" : {"dataIndex" : "JobIDcheckBox"},
		    "JobId" : {"dataIndex":"JobID"},
		    ...
		    "MinorStatus": {"dataIndex":"MinorStatus","properties":{flex:1}},
		    "ApplicationStatus":{"dataIndex":"ApplicationStatus"},
		    "Site" :{"dataIndex":"Site"},
		    "JobName" :{"dataIndex":"JobName","properties":{flex:1,width:200}},
		    "LastUpdate[UTC]" :{"dataIndex":"LastUpdateTime","renderer":Ext.util.Format.dateRenderer('Y-m-d H:i:s'),"properties":{width:150}},
		    "LastSignOfLife[UTC]" :{"dataIndex":"LastSignOfLife","renderer":Ext.util.Format.dateRenderer('Y-m-d H:i:s'),"properties":{width:150}},
		    "SubmissionTime[UTC]" :{"dataIndex":"SubmissionTime","renderer":Ext.util.Format.dateRenderer('Y-m-d H:i:s'),"properties":{width:150}},
		    "DIRACSetup" : {"dataIndex":"DIRACSetup","properties":{hidden:true}},
		    "FailedFlag" : {"dataIndex":"FailedFlag","properties":{hidden:true}},
		    "RescheduleCounter" : {"dataIndex":"RescheduleCounter","properties":{hidden:true}},
        "CPUTime" : {"dataIndex":"CPUTime","properties":{hidden:true}},
        "OwnerDN" : {"dataIndex":"OwnerDN","properties":{hidden:true}},
        "JobGroup" : {"dataIndex":"JobGroup","properties":{hidden:true}},
        "JobType" : {"dataIndex":"JobType","properties":{hidden:true}},
        "AccountedFlag" : {"dataIndex":"AccountedFlag","properties":{hidden:true}},
        "OSandboxReadyFlag" : {"dataIndex":"OSandboxReadyFlag","properties":{hidden:true}},
        "Owner" : {"dataIndex":"Owner"},
        "TaskQueueID" : {"dataIndex":"TaskQueueID","properties":{hidden:true}},
        "OwnerGroup" : {"dataIndex":"OwnerGroup","properties":{hidden:true}}
		};

		var actionSubmenu = {
        'Visible':[
                   {"text":"Kill", "handler":me.__oprJobAction,"arguments":["kill",GLOBAL.APP.CF.getFieldValueFromSelectedRow(me.grid, "JobID")],"properties":{tooltip:'Click to kill the selected job.',iconCls : "dirac-icon-kill"}},
                   {"text":"Delete", "handler":me.__oprJobAction,"arguments":["delete",GLOBAL.APP.CF.getFieldValueFromSelectedRow(me.grid, "JobID")],"properties":{tooltip:'Click to kill the selected job.',iconCls : "dirac-icon-delete"}}
                   ]};
		var pilotSubmenu = {
        'Visible':[
                   {"text":"Get StdOut", "handler":me.__oprGetJobData,"arguments":["getPilotStdOut",GLOBAL.APP.CF.getFieldValueFromSelectedRow(me.grid, "JobID")],"properties":{tooltip:'Click to kill the selected job.',iconCls : "dirac-icon-download"}},
                   {"text":"Get StdErr", "handler":me.__oprGetJobData,"arguments":["getPilotStdErr",GLOBAL.APP.CF.getFieldValueFromSelectedRow(me.grid, "JobID")],"properties":{tooltip:'Click to kill the selected job.',iconCls : "dirac-icon-download"}},
                   {"text":"LoggingInfo", "handler":me.__oprGetJobData,"arguments":["getPilotLoggingInfo",GLOBAL.APP.CF.getFieldValueFromSelectedRow(me.grid, "JobID")],"properties":{tooltip:'Click to kill the selected job.',iconCls : "dirac-icon-download"}}
                   ]};
        ...
        'Visible':[
                   ...
                   {"text":"Parameters",    "handler":me.__oprGetJobData, "arguments":["getParams"], "properties":{tooltip:'Click to show the Parameters of the selected job.'}},
                   {"text":"Logging info",  "handler":me.__oprGetJobData, "arguments":["getLoggingInfo"], "properties":{tooltip:'Click to show the log of the selected job.'}},
                   {"text":"-"},//separator
                   {"text":"Peek StandardOutput",  "handler":me.__oprGetJobData, "arguments":["getStandardOutput"], "properties":{tooltip:'Click to retrive the stdout of the selected job.'}},
                   {"text":"Get LogFile",          "handler":me.__oprGetJobData, "arguments":["getLogURL"], "properties":{tooltip:'Click to download the log file of the jobs.', iconCls : "dirac-icon-download"}},
                   {"text":"Get StagerReport",     "handler":me.__oprGetJobData, "arguments":["getPending"], "properties":{tooltip:'Click to show the stager log.', iconCls : "dirac-icon-download"}},
                   {"text":"-"},//separator
                   {"text":"Actions", "subMenu": actionSubmenu, "properties":{iconCls : "dirac-icon-action",}},
                   {"text":"Pilot",  "subMenu":  pilotSubmenu, "properties":{iconCls : "dirac-icon-action",}},
