Ext.define('DIRAC.ApplicationWizard.classes.Presenter', {
      ...
      requires : ['Ext.dirac.views.tabs.Presenter', 'LHCbDIRAC.Accounting.classes.Image', 'Ext.dirac.views.tabs.Panel'],
      view : 'presenterView',
      region : 'center',
      minWidth : 300,
      title : name,
          ...
          var config = {
            ...
            listeners : {
              beforeclose : function(panel, eOpts) {
                ...
                activeTab.closeRemoveApplication(panel); // generate a close event again.
      ...
      addImages : function(images) {
        ...
        for (var i = 0; i < images.length; i++) {
          ...
          var oImg = Ext.create('LHCbDIRAC.Accounting.classes.Image', {
                layout : 'column',
                columnWidth : width,
                src : images[i]
              });
