...
Ext.define("Ext.dirac.core.Container", {
  ...
  oprPrepareAndShowWindowGrid: function(
    oData,
    sTitle,
    oFields,
    oColumns,
  ...
  oprShowInNewTab: function(url, title) {
    if (Ext.isSafari) {
      var panelContent = new Ext.panel.Panel({
        ...
        scrollable: true,
        html:
          '<iframe style="overflow:auto;width:100%;height:100%;" frameborder="0"  src="' +
          url +
          '"></iframe>'
      });
      ...
      if (win == null || typeof win == "undefined") {
        Ext.dirac.system_info.msg(
          "Error Notification",
          'Please disable your pop-up blocker and click the "same component" again.'
        );
      } else {
        win.focus();
      }
