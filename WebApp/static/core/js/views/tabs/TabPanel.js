...
Ext.define("Ext.dirac.views.tabs.TabPanel", {
  ...
  loadState: function(data) {
    ...
    if (
      ...
      data.views &&
      data.views.tabs &&
      data.views.tabs.tabChangeCycle
    ) {
  ...
  getStateData: function() {
    ...
    if (desktopName && desktopName != "Default") {
      if (
        GLOBAL.APP.SM.isStateLoaded("application", "desktop", desktopName) > -1
      ) {
        desktopData = GLOBAL.APP.SM.getStateData(
          "application",
          "desktop",
          desktopName
        );
    ...
    try {
      me.items.each(function(win, value, length) {
        ...
        if (!win.isLoaded) {
          if (
            Object.keys(apps) &&
            Ext.Array.contains(Object.keys(apps), win.getAppClassName()) &&
      ...
      me.items.each(function(win, value, length) {
        ...
        if (!win.isLoaded) {
          if (
            Object.keys(toLoadApps) &&
            Ext.Array.contains(Object.keys(toLoadApps), win.getAppClassName())
          ) {
        ...
        if (win.isLoaded) {
          ...
          if (desktopName) {
            ...
            if (desktopData) {
              ...
              var data = GLOBAL.APP.SM.getStateData(
                "application",
                win.getAppClassName(),
                win.currentState
              );
              ...
              Ext.dirac.system_info.msg(
                "Error Notification",
                "The following desktop can not be saved:" + desktopName
              );
            }
          }
        }
      ...
      Ext.dirac.system_info.msg(
        "Error Notification",
        "The following desktop can not be saved:" + me.title
      );
  ...
  listeners: {
    ...
    tabchange: function(tabPanel, newCard, oldCard, eOpts) {
      ...
      if (newCard.type == "desktop") {
        ...
        if (
          !GLOBAL.APP.MAIN_VIEW.loading &&
          !newCard.isLoaded &&
          newCard.title != "Default"
        ) {
        ...
        if (oldCard) {
          GLOBAL.APP.SM.oprRemoveActiveState(
            oldCard.getClassName(),
            oldCard.currentState
          );
  ...
  getApplicationTab: function(appClassName, stateName) {
    ...
    me.items.each(function(panelObj, value, length) {
      if (
        panelObj.appClassName == appClassName &&
        panelObj.currentState == stateName
      ) {
        panel = panelObj;
        return;
      }
