...
Ext.define('Ext.dirac.views.tabs.Main', {
     ...
     * which are in the URL. #param{Object} cbFunction is a function which will
     * be called after the desktop states active.
     */
    ...
    createWindow : function(loadedObjectType, moduleName, setupData, oTab, cbFunction) {
        ...
        if (loadedObjectType == "app") {
            ...
            if (GLOBAL.DEV == 0) {
                ...
                oConfig["paths"][oParts[0] + "." + oParts[1] + ".classes"] = "static/" + oParts[0] + "/" + oParts[1]
                        + "/build";
    ...
    saveActiveApplicationState : function() {
        ...
        if (activeDesktop) {
            ...
            if (appl) {
                ...
                GLOBAL.APP.MAIN_VIEW.SM.oprSaveAppState("application", appl.loadedObject.self.getName(),
                        appl.loadedObject, funcAfterSave);
    ...
    saveAsActiveApplicationState : function() {
        ...
        if (activeDesktop) {
            ...
            if (appl) {
                ...
                GLOBAL.APP.MAIN_VIEW.SM.formSaveState("application", appl.loadedObject.self.getName(),
                        appl.loadedObject, funcAfterSave);
