...
Ext.define("Ext.dirac.views.tabs.Panel", {
      ...
      if (me.loadedObjectType == "app") {
        try {
          ...
          Ext.dirac.system_info.msg(
            "Error Notification",
            "Application: " + me.getAppClassName() + " : " + err
          );
        }
      } else if (me.loadedObjectType == "link")
  ...
  setLoadedObject: function(setupData, loadState) {
    ...
    if (setupData.stateToLoad && setupData.stateToLoad != "Default") {
      me.oprLoadAppStateFromCache(
        setupData.stateToLoad,
        loadState,
        setupData.desktop
      );
    } else {
  ...
  oprLoadAppStateFromCache: function(stateName, loadState, desktopName) {
    ...
    switch (iStateLoaded) {
      ...
      case -2:
        ...
        // cache.
        var oStates = GLOBAL.APP.SM.getStateData(
          "application",
          "desktop",
          desktopName
        );
        ...
        if (!oState)
          GLOBAL.APP.CF.alert(
            "The state" + stateName + " does not exist !",
            "warning"
          );
        break;
      case 1:
        var oState = GLOBAL.APP.SM.getStateData(
          "application",
          me.appClassName,
          stateName
        );
