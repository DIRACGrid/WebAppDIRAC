 ...
 */
Ext.define('Ext.dirac.views.tabs.TabCloseMenu', {
      ...
      /**
       * @cfg {Array} extraItemsHead An array of additional context menu items
       *      to add to the front of the context menu.
       */
      extraItemsHead : null,

      /**
       * @cfg {Array} extraItemsTail An array of additional context menu items
       *      to add to the end of the context menu.
       */
      extraItemsTail : null,
