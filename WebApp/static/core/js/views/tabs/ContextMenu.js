      ...
      items: [
        ...
        },
        {
          ...
          handler: function() {
            ...
            GLOBAL.APP.SM.oprChangeSharedStateToPrivate(
              app,
              me.oSelectedMenuItem.data.text,
              function(rCode, rAppName, rStateName, rMessage) {
                if (rCode == 1) {
                  var oHtml = "";
                  oHtml +=
                    "<div style='padding:5px'>The desktop access has changed to private:</div>";
                  oHtml +=
                    "<div style='padding:5px;font-weight:bold'>" +
                    rMessage +
                    "</div>";
                  ...
                  Ext.MessageBox.alert(
                    "Info for making private the <span style='color:red'>" +
                      rStateName +
                      "</span> state:",
                    oHtml
                  );
          ...
          handler: function() {
            ...
            Ext.Ajax.request({
              ...
              success: function(response) {
                ...
                switch (iStateLoaded) {
                  ...
                  case -2:
                    me.funcPostponedLoading = function() {
                      GLOBAL.APP.CF.alert(
                        "Network problem during the svae...",
                        "warning"
                      );
                    };
                ...
                GLOBAL.APP.SM.cache["application"]["desktop"][
                  me.oSelectedMenuItem.data.text
                ].view = "presenterView"; // it
                // is a
                // hack
                Ext.dirac.system_info.msg(
                  "Notification",
                  "Desktop view has changed successfully !"
                );
              },
        ...
        },
        {
          ...
          handler: function() {
            if (me.oSelectedMenuItem.data.type == "app") {
              ...
              GLOBAL.APP.MAIN_VIEW.saveDesktopState(
                me.oSelectedMenuItem.data.text
              );
            }
          }
        ...
        },
        {
          ...
          handler: function() {
            ...
            if (me.oSelectedMenuItem.data.type == "app") {
              ...
              if (
                me.oSelectedMenuItem.data.desktop == "" ||
                me.oSelectedMenuItem.data.desktop === undefined
              ) {
                GLOBAL.APP.MAIN_VIEW.SM.deleteState(
                  me.oSelectedMenuItem.data.application,
                  me.oSelectedMenuItem.data.text,
                  function(returnCode, appName, stateType, stateName) {
                    GLOBAL.APP.MAIN_VIEW.removeNodeFormDefaultDesktop(
                      me.oSelectedMenuItem.data.text
                    );
                    GLOBAL.APP.MAIN_VIEW.closeApplication(
                      me.oSelectedMenuItem.data.desktop,
                      me.oSelectedMenuItem.data.text
                ...
                GLOBAL.APP.MAIN_VIEW.SM.deleteStateFromDesktop(
                  ...
                  me.oSelectedMenuItem.data.text,
                  function(returnCode, appName, stateType, stateName) {
                    GLOBAL.APP.MAIN_VIEW.removeApplicationFromDesktop(
                      me.oSelectedMenuItem.data.desktop,
                      me.oSelectedMenuItem.data.text
                    );
                    GLOBAL.APP.MAIN_VIEW.closeApplication(
