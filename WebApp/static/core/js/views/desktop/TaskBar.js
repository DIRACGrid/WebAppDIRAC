...
Ext.define('Ext.dirac.views.desktop.TaskBar', {
      ...
      requires : ['Ext.button.Button', 'Ext.resizer.Splitter', 'Ext.menu.Menu', 'Ext.dirac.views.desktop.StartMenu', 'Ext.toolbar.TextItem', 'Ext.dirac.views.tabs.SettingsPanel'],
