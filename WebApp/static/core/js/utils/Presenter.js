...
Ext.define("Ext.dirac.utils.Presenter", {
  ...
  loadState: function(oData) {
    ...
    me.autoRefresh.items
      .getAt(me.autoRefresh.items.findIndex("value", me.refreshCycle))
      .setChecked(true);
  ...
  initComponent: function() {
          ...
          Ext.defer(
            function() {
              if (me.mouseup == false) {
                ...
                me.autoRefresh.items
                  .getAt(
                    me.autoRefresh.items.findIndex("value", me.refreshCycle)
                  )
                  .setChecked(true);
    ...
    me.updateTime = Ext.create("Ext.form.Label", {
      ...
      text: "Updated: -",
      style:
        GLOBAL.WEB_THEME == "ext-all-neptune"
      ...
      el.on(
        ...
        function(e, t, eOpts, me) {
          ...
          if (img) {
            ...
            me.scope.actualReport =
              img.reportType != null ? img.reportType : "Accounting";
            me.selectImage(img);
            ...
            items: [
                ...
                handler: function() {
                  ...
                  for (var oParam in oParams) {
                    oHrefParams +=
                      ...
                      oParam +
                      "=" +
                      encodeURIComponent(oParams[oParam]);
                  }

                  window.open(
                    GLOBAL.BASE_URL +
                      me.scope.handlers[img.reportType] +
                      "/getCsvPlotData?" +
                      oHrefParams
                  );
                }
              ...
              },
              {
                ...
                handler: function() {
                  ...
                  me.parent
                    .getContainer()
                    .oprPrepareAndShowWindowText(url, "URL");
                }
              }
            ]
          });
  ...
  fullSizeImage: function(img) {
    ...
    var win = me
      .up("panel")
      .createChildWindow(
        img.plotParams._typeName + "::" + img.plotParams._plotTitle,
        false,
        850,
        650
      );
    ...
    if (time == 0) {
      ...
      me.items.each(function(value, index) {
        ...
        Ext.Ajax.request({
          url:
            GLOBAL.BASE_URL +
            me.scope.handlers[value.reportType] +
            "/generatePlot",
          timeout: me.timeout,
          params: value.plotParams,
