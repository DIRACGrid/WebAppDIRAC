...
Ext.define('Ext.dirac.utils.DiracToolButton', {
	...
	initComponent : function() {
		...
		me.addEvents(
		/**
		 * @event menushow If this button has a menu, this event fires when it is
		 *        shown
		...
		/**
		 * @event menuhide If this button has a menu, this event fires when it is
		 *        hidden
		 * @param {Ext.button.Button}
		 *          this
		 * @param {Ext.menu.Menu}
		...
		/**
		 * @event menutriggerover If this button has a menu, this event fires when
		 *        the mouse enters the menu triggering element
		 * @param {Ext.button.Button}
		 *          this
		 * @param {Ext.menu.Menu}
		 *          menu
		...
		/**
		 * @event menutriggerout If this button has a menu, this event fires when
		 *        the mouse leaves the menu triggering element
		 * @param {Ext.button.Button}
		 *          this
		 * @param {Ext.menu.Menu}
		 *          menu
