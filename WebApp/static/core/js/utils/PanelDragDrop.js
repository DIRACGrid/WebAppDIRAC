    ...
    if (me.enableDrag) {
     ...
     me.dragZone = new Ext.dd.DragZone(view.getEl(), {
        ...
        getDragData : function(e) {
         var view = this.view, item = e.getTarget().id, record = view.getComponent(item);
         if (item) {
        ...
        onInitDrag : function(x, y) {
         var self = this, data = self.dragData, view = self.view,
         //selectionModel = view.getSelectionModel(),
         record = data.record, el = data.ddel;
    ...
    if (me.enableDrop) {
     me.dropZone = new Ext.dd.DropZone(view.el, {
        ...
        getTargetFromEvent : function(e) {
         var me = this, v = me.view, image = e.getTarget(), imageid, imageobj;
        ...
        onNodeEnter : function(target, dd, e, dragData) {
         ...
         if (target.record != null) { //only allow to drop element, if the target an image. What about copy from other window?
          var destType = target.record.id, sourceType = dragData.record.id;
